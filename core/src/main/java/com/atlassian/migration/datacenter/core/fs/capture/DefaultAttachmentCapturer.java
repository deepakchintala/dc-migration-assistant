...
public class DefaultAttachmentCapturer implements AttachmentCapturer {

    private static final Logger logger = LoggerFactory.getLogger(DefaultAttachmentCapturer.class);
